 ...
 * @var \App\Model\Entity\Follow[]|\Cake\Collection\CollectionInterface $follow
 */
?>
...
<div class="follow index large-9 medium-8 columns content">
    <h3><?= __('Follow') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('followed_user') ?></th>
