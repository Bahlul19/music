                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <h2 style="font-family: Verdana,Geneva,sans-serif;">Thank you <?= $applierName; ?> for registering with us.</h2>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="center" class="inner" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" valign="middle">
                      <p style="font-weight: bold; font-size: 16px; font-family: Verdana,Geneva,sans-serif;">
                        For logging into your account, please use the following link:
                      </p>
                        <?php
                          echo $this->Html->link(
                              'My profile',
                              ['controller' => 'profiles', 'action' => 'myaccount', '_full' => true],
