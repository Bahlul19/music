                        ...
                        <div class="col-lg-6">
                            ...
                            if($mynotifications == 1)
                            {
                                if($type == 1)
                                {
                                    ...
                                    <button type="submit" class="btn btn-danger d-none" onclick = "delete_post(<?php echo $value['id'] ?>);" value="Delete">
                                ...
                                { ?>
                                    ...
                                    <button  type="submit" class="btn btn-danger d-none" onclick = "delete_media(<?php echo $value['mediameta_id'] ?>);" value="Delete">
                                    <i class="fa fa-trash" aria-hidden="true"></i>
                                    </button>
