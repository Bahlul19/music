...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <?php echo $this->Html->css('../css/admin.css');?>
...
<?php echo $this->Html->script('/js/custom3.js'); ?>
<?php echo $this->Html->script('/js/admin3.js'); ?>
...
<?= $this->Html->script('../js/pollingQuestions.js'); ?>

<?= $this->Html->script('../js/fixedPollingJsIssue.js'); ?>

<?= $this->Html->script('../js/jquery.barfiller.js'); ?>
