        ...
        <div class="col-xs-12 col-sm-offset-3 col-sm-6">
            <div class="panel panel-default">
                <div class="panel-heading c-list">
                    <span class="title">Friends Requests</span>
                </div>
                ...
                <ul class="list-group" id="contact-list">
                   ...
                   <font class="black-font"> <li class="list-group-item">
                        ...
                        <div class="col-xs-12 col-sm-3">
                            <a href="<?php echo '/profiles/acceptfriendrequest/'.$row->id.'/'.$row->profile->id;?>"><button>Accept</button></a>
                            <a href="<?php echo '/profiles/rejectfriendrequest/'.$row->id.'/'.$row->profile->id;?>"><button>Reject</button></a>
                        </div>
                    ...
                    <font class="black-font">
                        <li class="list-group-item">
                            <div class="col-xs-12 col-sm-12">
                                <h3>No Pending Friend Requests</h1>
                            </div>
                             <div class="clearfix"></div>
                        </li>
                    </font>
