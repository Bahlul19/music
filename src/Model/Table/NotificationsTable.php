 ...
 * @property \App\Model\Table\NotificationLikesTable|\Cake\ORM\Association\HasMany $NotificationLikes
 *
...
class NotificationsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('NotificationLikes', [
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->allowEmptyString('notification', false);
